...
const ICONS = {
  ...
  signatures: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M3 17.5c1.5-2.5 4-2.5 5.5 0s4 2.5 5.5 0 4-2.5 5.5 0"/><path d="M3 13c2-3 4-3 6 0s4 3 6 0 4-3 6 0"/><path d="M3 8.5c1.5-2 4-2 5.5 0s4 2 5.5 0 4-2 5.5 0"/></svg>`,
  ...
  return `<aside class="sidebar">
    ...
    <div class="nav-group">
      ...
      <nav>
        ...
        ${item('signatures', '/signatures.html', 'Assinaturas Digitais')}
      </nav>
    </div>
